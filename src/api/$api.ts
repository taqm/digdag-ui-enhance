...
import { Methods as Methods0 } from './api/admin/attempts/_id@number/userinfo'
import { Methods as Methods1 } from './api/attempts'
import { Methods as Methods2 } from './api/attempts/_id@number'
import { Methods as Methods3 } from './api/attempts/_id@number/retries'
import { Methods as Methods4 } from './api/attempts/_id@number/tasks'
import { Methods as Methods5 } from './api/logs/_attempt_id@number/files'
import { Methods as Methods6 } from './api/logs/_attempt_id@number/files/_file_name@string'
import { Methods as Methods7 } from './api/logs/_attempt_id@number/upload_handle'
import { Methods as Methods8 } from './api/project'
import { Methods as Methods9 } from './api/projects'
import { Methods as Methods10 } from './api/projects/_id@number'
import { Methods as Methods11 } from './api/projects/_id@number/archive'
import { Methods as Methods12 } from './api/projects/_id@number/revisions'
import { Methods as Methods13 } from './api/projects/_id@number/schedules'
import { Methods as Methods14 } from './api/projects/_id@number/secrets'
import { Methods as Methods15 } from './api/projects/_id@number/secrets/_key@string'
import { Methods as Methods16 } from './api/projects/_id@number/sessions'
import { Methods as Methods17 } from './api/projects/_id@number/workflow'
import { Methods as Methods18 } from './api/projects/_id@number/workflows'
import { Methods as Methods19 } from './api/projects/_id@number/workflows/_name@string'
import { Methods as Methods20 } from './api/schedules'
import { Methods as Methods21 } from './api/schedules/_id@number'
import { Methods as Methods22 } from './api/schedules/_id@number/backfill'
import { Methods as Methods23 } from './api/schedules/_id@number/disable'
import { Methods as Methods24 } from './api/schedules/_id@number/enable'
import { Methods as Methods25 } from './api/schedules/_id@number/skip'
import { Methods as Methods26 } from './api/sessions'
import { Methods as Methods27 } from './api/sessions/_id@number'
import { Methods as Methods28 } from './api/sessions/_id@number/attempts'
import { Methods as Methods29 } from './api/version'
import { Methods as Methods30 } from './api/version/check'
import { Methods as Methods31 } from './api/workflow'
import { Methods as Methods32 } from './api/workflows'
import { Methods as Methods33 } from './api/workflows/_id@number'
import { Methods as Methods34 } from './api/workflows/_id@number/truncated_session_time'
...
const api = <T>({ baseURL, fetch }: AspidaClient<T>) => {
  ...
  return {
    api: {
        ...
        attempts: {
          _id: (val3: number) => {
            ...
            return {
              userinfo: {
                get: (option?: { config?: T }) =>
                  fetch<Methods0['get']['resBody'], Methods0['get']['resHeaders'], Methods0['get']['status']>(prefix, `${prefix3}${PATH1}`, GET, option).json(),
                $get: (option?: { config?: T }) =>
                  fetch<Methods0['get']['resBody'], Methods0['get']['resHeaders'], Methods0['get']['status']>(prefix, `${prefix3}${PATH1}`, GET, option).json().then(r => r.body),
      ...
      attempts: {
        _id: (val2: number) => {
          ...
          return {
            retries: {
              get: (option?: { config?: T }) =>
                fetch<Methods3['get']['resBody'], BasicHeaders, Methods3['get']['status']>(prefix, `${prefix2}${PATH3}`, GET, option).json(),
              $get: (option?: { config?: T }) =>
                fetch<Methods3['get']['resBody'], BasicHeaders, Methods3['get']['status']>(prefix, `${prefix2}${PATH3}`, GET, option).json().then(r => r.body),
              $path: () => `${prefix}${prefix2}${PATH3}`
            },
            tasks: {
              get: (option?: { config?: T }) =>
                fetch<Methods4['get']['resBody'], BasicHeaders, Methods4['get']['status']>(prefix, `${prefix2}${PATH4}`, GET, option).json(),
              $get: (option?: { config?: T }) =>
                fetch<Methods4['get']['resBody'], BasicHeaders, Methods4['get']['status']>(prefix, `${prefix2}${PATH4}`, GET, option).json().then(r => r.body),
      ...
      logs: {
        _attempt_id: (val2: number) => {
          const prefix2 = `${PATH5}/${val2}`

          return {
            files: {
              _file_name: (val4: string) => {
                const prefix4 = `${prefix2}${PATH6}/${val4}`

                return {
                  get: (option?: { config?: T }) =>
                    fetch<void, BasicHeaders, Methods6['get']['status']>(prefix, prefix4, GET, option).send(),
                  $get: (option?: { config?: T }) =>
                    fetch<void, BasicHeaders, Methods6['get']['status']>(prefix, prefix4, GET, option).send().then(r => r.body),
                  $path: () => `${prefix}${prefix4}`
                }
              },
              get: (option?: { query?: Methods5['get']['query'], config?: T }) =>
                fetch<Methods5['get']['resBody'], BasicHeaders, Methods5['get']['status']>(prefix, `${prefix2}${PATH6}`, GET, option).json(),
              $get: (option?: { query?: Methods5['get']['query'], config?: T }) =>
                fetch<Methods5['get']['resBody'], BasicHeaders, Methods5['get']['status']>(prefix, `${prefix2}${PATH6}`, GET, option).json().then(r => r.body),
              put: (option: { body: Methods5['put']['reqBody'], query?: Methods5['put']['query'], config?: T }) =>
                fetch<Methods5['put']['resBody'], Methods5['put']['resHeaders'], Methods5['put']['status']>(prefix, `${prefix2}${PATH6}`, PUT, option).json(),
              $put: (option: { body: Methods5['put']['reqBody'], query?: Methods5['put']['query'], config?: T }) =>
                fetch<Methods5['put']['resBody'], Methods5['put']['resHeaders'], Methods5['put']['status']>(prefix, `${prefix2}${PATH6}`, PUT, option).json().then(r => r.body),
            ...
            upload_handle: {
              get: (option?: { query?: Methods7['get']['query'], config?: T }) =>
                fetch<Methods7['get']['resBody'], Methods7['get']['resHeaders'], Methods7['get']['status']>(prefix, `${prefix2}${PATH7}`, GET, option).json(),
              $get: (option?: { query?: Methods7['get']['query'], config?: T }) =>
                fetch<Methods7['get']['resBody'], Methods7['get']['resHeaders'], Methods7['get']['status']>(prefix, `${prefix2}${PATH7}`, GET, option).json().then(r => r.body),
          ...
          return {
            archive: {
              get: (option: { query: Methods11['get']['query'], config?: T }) =>
                fetch(prefix, `${prefix2}${PATH10}`, GET, option).send(),
              $get: (option: { query: Methods11['get']['query'], config?: T }) =>
                fetch(prefix, `${prefix2}${PATH10}`, GET, option).send().then(r => r.body),
            ...
            revisions: {
              get: (option?: { query?: Methods12['get']['query'], config?: T }) =>
                fetch<Methods12['get']['resBody'], BasicHeaders, Methods12['get']['status']>(prefix, `${prefix2}${PATH11}`, GET, option).json(),
              $get: (option?: { query?: Methods12['get']['query'], config?: T }) =>
                fetch<Methods12['get']['resBody'], BasicHeaders, Methods12['get']['status']>(prefix, `${prefix2}${PATH11}`, GET, option).json().then(r => r.body),
            ...
            secrets: {
              _key: (val4: string) => {
                const prefix4 = `${prefix2}${PATH13}/${val4}`

                return {
                  put: (option: { body: Methods15['put']['reqBody'], config?: T }) =>
                    fetch(prefix, prefix4, PUT, option).send(),
                  $put: (option: { body: Methods15['put']['reqBody'], config?: T }) =>
                    fetch(prefix, prefix4, PUT, option).send().then(r => r.body),
                  delete: (option?: { config?: T }) =>
                    fetch(prefix, prefix4, DELETE, option).send(),
                  $delete: (option?: { config?: T }) =>
                    fetch(prefix, prefix4, DELETE, option).send().then(r => r.body),
                  $path: () => `${prefix}${prefix4}`
                }
              },
              get: (option?: { config?: T }) =>
                fetch<Methods14['get']['resBody'], BasicHeaders, Methods14['get']['status']>(prefix, `${prefix2}${PATH13}`, GET, option).json(),
              $get: (option?: { config?: T }) =>
                fetch<Methods14['get']['resBody'], BasicHeaders, Methods14['get']['status']>(prefix, `${prefix2}${PATH13}`, GET, option).json().then(r => r.body),
              $path: () => `${prefix}${prefix2}${PATH13}`
            },
            sessions: {
              get: (option?: { query?: Methods16['get']['query'], config?: T }) =>
                fetch<Methods16['get']['resBody'], BasicHeaders, Methods16['get']['status']>(prefix, `${prefix2}${PATH14}`, GET, option).json(),
              $get: (option?: { query?: Methods16['get']['query'], config?: T }) =>
                fetch<Methods16['get']['resBody'], BasicHeaders, Methods16['get']['status']>(prefix, `${prefix2}${PATH14}`, GET, option).json().then(r => r.body),
            ...
            workflow: {
              get: (option?: { query?: Methods17['get']['query'], config?: T }) =>
                fetch<Methods17['get']['resBody'], Methods17['get']['resHeaders'], Methods17['get']['status']>(prefix, `${prefix2}${PATH15}`, GET, option).json(),
              $get: (option?: { query?: Methods17['get']['query'], config?: T }) =>
                fetch<Methods17['get']['resBody'], Methods17['get']['resHeaders'], Methods17['get']['status']>(prefix, `${prefix2}${PATH15}`, GET, option).json().then(r => r.body),
            ...
            workflows: {
              _name: (val4: string) => {
                ...
                return {
                  get: (option?: { query?: Methods19['get']['query'], config?: T }) =>
                    fetch<Methods19['get']['resBody'], Methods19['get']['resHeaders'], Methods19['get']['status']>(prefix, prefix4, GET, option).json(),
                  $get: (option?: { query?: Methods19['get']['query'], config?: T }) =>
                    fetch<Methods19['get']['resBody'], Methods19['get']['resHeaders'], Methods19['get']['status']>(prefix, prefix4, GET, option).json().then(r => r.body),
              ...
              get: (option?: { query?: Methods18['get']['query'], config?: T }) =>
                fetch<Methods18['get']['resBody'], BasicHeaders, Methods18['get']['status']>(prefix, `${prefix2}${PATH16}`, GET, option).json(),
              $get: (option?: { query?: Methods18['get']['query'], config?: T }) =>
                fetch<Methods18['get']['resBody'], BasicHeaders, Methods18['get']['status']>(prefix, `${prefix2}${PATH16}`, GET, option).json().then(r => r.body),
            ...
            delete: (option?: { config?: T }) =>
              fetch<Methods10['delete']['resBody'], BasicHeaders, Methods10['delete']['status']>(prefix, prefix2, DELETE, option).json(),
            $delete: (option?: { config?: T }) =>
              fetch<Methods10['delete']['resBody'], BasicHeaders, Methods10['delete']['status']>(prefix, prefix2, DELETE, option).json().then(r => r.body),
            $path: () => `${prefix}${prefix2}`
          }
        },
          ...
          return {
            backfill: {
              post: (option: { body: Methods22['post']['reqBody'], config?: T }) =>
                fetch<Methods22['post']['resBody'], BasicHeaders, Methods22['post']['status']>(prefix, `${prefix2}${PATH18}`, POST, option).json(),
              $post: (option: { body: Methods22['post']['reqBody'], config?: T }) =>
                fetch<Methods22['post']['resBody'], BasicHeaders, Methods22['post']['status']>(prefix, `${prefix2}${PATH18}`, POST, option).json().then(r => r.body),
              $path: () => `${prefix}${prefix2}${PATH18}`
            },
            disable: {
              post: (option?: { config?: T }) =>
                fetch<Methods23['post']['resBody'], BasicHeaders, Methods23['post']['status']>(prefix, `${prefix2}${PATH19}`, POST, option).json(),
              $post: (option?: { config?: T }) =>
                fetch<Methods23['post']['resBody'], BasicHeaders, Methods23['post']['status']>(prefix, `${prefix2}${PATH19}`, POST, option).json().then(r => r.body),
            ...
            skip: {
              post: (option: { body: Methods25['post']['reqBody'], config?: T }) =>
                fetch<Methods25['post']['resBody'], BasicHeaders, Methods25['post']['status']>(prefix, `${prefix2}${PATH21}`, POST, option).json(),
              $post: (option: { body: Methods25['post']['reqBody'], config?: T }) =>
                fetch<Methods25['post']['resBody'], BasicHeaders, Methods25['post']['status']>(prefix, `${prefix2}${PATH21}`, POST, option).json().then(r => r.body),
          ...
          return {
            attempts: {
              get: (option?: { query?: Methods28['get']['query'], config?: T }) =>
                fetch<Methods28['get']['resBody'], BasicHeaders, Methods28['get']['status']>(prefix, `${prefix2}${PATH23}`, GET, option).json(),
              $get: (option?: { query?: Methods28['get']['query'], config?: T }) =>
                fetch<Methods28['get']['resBody'], BasicHeaders, Methods28['get']['status']>(prefix, `${prefix2}${PATH23}`, GET, option).json().then(r => r.body),
          ...
          return {
            truncated_session_time: {
              get: (option?: { query?: Methods34['get']['query'], config?: T }) =>
                fetch<Methods34['get']['resBody'], BasicHeaders, Methods34['get']['status']>(prefix, `${prefix2}${PATH28}`, GET, option).json(),
              $get: (option?: { query?: Methods34['get']['query'], config?: T }) =>
                fetch<Methods34['get']['resBody'], BasicHeaders, Methods34['get']['status']>(prefix, `${prefix2}${PATH28}`, GET, option).json().then(r => r.body),
              $path: (option?: { method?: 'get'; query: Methods34['get']['query'] }) =>
                `${prefix}${prefix2}${PATH28}${option && option.query ? `?${dataToURLString(option.query)}` : ''}`
            },
            get: (option?: { config?: T }) =>
              fetch<Methods33['get']['resBody'], BasicHeaders, Methods33['get']['status']>(prefix, prefix2, GET, option).json(),
            $get: (option?: { config?: T }) =>
              fetch<Methods33['get']['resBody'], BasicHeaders, Methods33['get']['status']>(prefix, prefix2, GET, option).json().then(r => r.body),
            $path: () => `${prefix}${prefix2}`
          }
        },
